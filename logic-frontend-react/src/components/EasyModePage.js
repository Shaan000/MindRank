...
export default function EasyModePage({ user, accessToken, authInitialized }) {
  ...
  useEffect(() => {
    ...
    const skipInstructions = localStorage.getItem('skipEasyInstructions') === 'true';
    if (!skipInstructions) {
  ...
  return (
    <div style={appStyle}>
      ...
      <div style={headerStyle}>
        ...
        <h1 style={titleStyle}>Easy Mode</h1>
        <p style={{
          fontSize: '1.25rem',
