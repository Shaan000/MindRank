...
export default function HardModePage({ user, accessToken, authInitialized }) {
  ...
  useEffect(() => {
    ...
    const skipInstructions = localStorage.getItem('skipHardInstructions') === 'true';
    if (!skipInstructions) {
  ...
  return (
    <div style={appStyle}>
      ...
      <div style={headerStyle}>
        ...
        <h1 style={titleStyle}>Hard Mode</h1>
        <p style={{
          fontSize: '1.25rem',
                  ...
                  <div key={player} style={playerCardStyle}>
                    ...
                    <div style={buttonGroupStyle}>
                      <button
                        style={{
                          ...guessButtonStyle,
                          background: playerGuesses[player] === true ? '#e67e22' : '#3d3a37',
                          color: playerGuesses[player] === true ? '#ffffff' : '#b0a99f',
                          border: playerGuesses[player] === true ? '2px solid #e67e22' : '2px solid #3d3a37'
                        }}
                ...
                <div style={{display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap'}}>
                  {Object.entries(solution).map(([player, value]) => (
                    <span key={player} style={{
                      background: value ? '#e67e22' : '#cc8c14',
                      color: '#ffffff',
                      padding: '0.5rem 1rem',
                      borderRadius: '6px',
                      fontWeight: '600'
