...
export default function MasterEasyModePage({ user, accessToken, authInitialized }) {
  ...
  useEffect(() => {
    ...
    const skipInstructions = localStorage.getItem('skipMasterEasyInstructions') === 'true';
    if (!skipInstructions) {
  ...
  return (
    <div style={appStyle}>
      ...
      <div style={headerStyle}>
        ...
        <h1 style={titleStyle}>Master Easy Mode 🔥</h1>
        <p style={{
          fontSize: '1.25rem',
          ...
          No Takebacks! Permanent Selections Challenge Your Pure Logic
        </p>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        {isLoading ? (
          <div style={{...cardStyle, textAlign: 'center'}}>
            <p style={{color: '#b0a99f', fontSize: '1.25rem'}}>Generating master puzzle...</p>
          </div>
        ) : puzzle ? (
          <div style={cardStyle}>
            <h3 style={{
      ...
      {showInstructions && (
        <InstructionsModal
          ...
          skipKey="skipMasterEasyInstructions"
